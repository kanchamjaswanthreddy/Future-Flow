...
export default function PrivacyPage() {
  return (
    <div style={{ paddingTop: 72 }}>
      <SEO
        title="Privacy Policy — FutureFlow"
        description="FutureFlow never sells your data. Learn how we protect your financial information with bank-grade 256-bit AES encryption and read-only Plaid connections."
        canonical="/privacy"
        noindex={true}
      />
